...
/*
* Override setFrame to scale imageview to crop image from top.
...
public class IntroImageView extends ImageView {
    ...
    public IntroImageView(Context context, AttributeSet attrs){
        super(context, attrs);
    }

    public IntroImageView(Context context, AttributeSet attrs, int defStyle) {
